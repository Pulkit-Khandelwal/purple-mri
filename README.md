...
Next, correct for topology so that adjoining gyri and sulci are clearly separated. Copy the segmentations from `output_from_nnunet_inference` to a folder `data_for_topology_correction` in your working directory.
```
...
+ Khandelwal, Pulkit, et al. "Surface-Based Parcellation and Vertex-wise Analysis of Ultra High-resolution ex vivo 7 tesla MRI in Alzheimer’s disease and related dementias." International Workshop on Machine Learning in Clinical Neuroimaging. Springer, Cham, 2025.
