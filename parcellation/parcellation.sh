...
######### segm_parc file
mris_place_surface --adgws-in ${miccai_stuff}/autodet.gw.stats.BINARY.rh.dat \
--wm ${SUBJECTS_DIR}/${subj}/mri/wm.mgz --threads 64 --invol ${SUBJECTS_DIR}/${subj}/mri/aseg.presurf_100.mgz --${hemis} \
...
mris_register -curv -threads 64 -inflated -init \
-reg ${SUBJECTS_DIR}/${subj}/mri/transforms/init_for_mris_register.lta \
${SUBJECTS_DIR}/${subj}/surf/${hemis}.sphere /data/pulkit/exvivo_reg_reconstruct/freesurfer_installation/freesurfer/average/${hemis}.folding.atlas.acfb40.noaparc.i12.2016-08-02.tif ${SUBJECTS_DIR}/${subj}/surf/${hemis}.sphere.reg
...
mrisp_paint -a 5 /data/pulkit/exvivo_reg_reconstruct/freesurfer_installation/freesurfer/average/${hemis}.folding.atlas.acfb40.noaparc.i12.2016-08-02.tif#6 ${SUBJECTS_DIR}/${subj}/surf/${hemis}.sphere.reg ${SUBJECTS_DIR}/${subj}/surf/${hemis}.avg_curv 

mris_ca_label -l ${SUBJECTS_DIR}/${subj}/label/${hemis}.cortex.label -aseg ${SUBJECTS_DIR}/${subj}/mri/aseg.presurf.mgz ${subj} ${hemis} ${SUBJECTS_DIR}/${subj}/surf/${hemis}.sphere.reg /data/pulkit/exvivo_reg_reconstruct/freesurfer_installation/freesurfer/average/${hemis}.DKaparc.atlas.acfb40.noaparc.i12.2016-08-02.gcs ${SUBJECTS_DIR}/${subj}/label/${hemis}.aparc.annot 

SUBJECTS_DIR=${freesurfer_surface_processed}

cd ${SUBJECTS_DIR}/${subj}/mri
mris_place_surface --adgws-in ${miccai_stuff}/autodet.gw.stats.BINARY.rh.dat \
--seg aseg.presurf.mgz --threads 64 --wm wm.mgz --invol aseg.presurf_100.mgz --${hemis} --i ../surf/${hemis}.white.preaparc --o ../surf/${hemis}.white --white --nsmooth 0 \
--rip-label ../label/${hemis}.cortex.label --rip-bg --rip-surf ../surf/${hemis}.white.preaparc --aparc ../label/${hemis}.aparc.annot

cd ${SUBJECTS_DIR}/${subj}/mri
mris_place_surface --adgws-in ${miccai_stuff}/autodet.gw.stats.BINARY.rh.dat \
--seg aseg.presurf.mgz --threads 64 --wm wm.mgz \
...
#@# Cortical Parc 2
cd ${SUBJECTS_DIR}/${subj}/mri
mris_ca_label -l ../label/${hemis}.cortex.label -aseg ../mri/aseg.presurf.mgz ${subj} ${hemis} ../surf/${hemis}.sphere.reg /data/pulkit/exvivo_reg_reconstruct/freesurfer_installation/freesurfer/average/${hemis}.CDaparc.atlas.acfb40.noaparc.i12.2016-08-02.gcs ../label/${hemis}.aparc.a2009s.annot 

#@# Cortical Parc 3
cd ${SUBJECTS_DIR}/${subj}/mri
mris_ca_label -l ../label/${hemis}.cortex.label -aseg ../mri/aseg.presurf.mgz ${subj} ${hemis} ../surf/${hemis}.sphere.reg /data/pulkit/exvivo_reg_reconstruct/freesurfer_installation/freesurfer/average/${hemis}.DKTaparc.atlas.acfb40.noaparc.i12.2016-08-02.gcs ../label/${hemis}.aparc.DKTatlas.annot 
...
mri_surf2surf --hemi ${hemis} \
  ...
  --trgsubject ${subj} \
  --sval-annot ${schaefer_data_dir}/${hemis}.Schaefer2018_400Parcels_7Networks_order.annot \
  --tval ${SUBJECTS_DIR}/${subj}/label/${hemis}.aparc.Schaefer2018_400Parcels_7Networks.annot 

SUBJECTS_DIR=${freesurfer_surface_processed}
#@# Cortical Parc Schaefer atlas: 7 and 17 networks
cd ${SUBJECTS_DIR}/${subj}/mri
schaefer_data_dir=/data/pulkit/CBIG/stable_projects/brain_parcellation/Schaefer2018_LocalGlobal/Parcellations/FreeSurfer5.3/fsaverage/label

mri_surf2surf --hemi ${hemis} \
  --srcsubject fsaverage \
  --trgsubject ${subj} \
  --sval-annot ${schaefer_data_dir}/${hemis}.Schaefer2018_400Parcels_17Networks_order.annot \
  --tval ${SUBJECTS_DIR}/${subj}/label/${hemis}.aparc.Schaefer2018_400Parcels_17Networks.annot

##### Economo-Koskinos atlas
cd ${SUBJECTS_DIR}/${subj}/mri
economo_data_dir=/data/pulkit/exvivo_reg_reconstruct/surface_stuff_freesurfer/miccai_stuff/freesurfer_exvivo_outputs/126704L_redo_correct_ribbon/economo
mris_ca_label -t ${economo_data_dir}/${hemis}.colortable.txt ${subj} ${hemis} ../surf/${hemis}.sphere.reg ${economo_data_dir}/${hemis}.economo.gcs \
${SUBJECTS_DIR}/${subj}/label/${hemis}.economo.annot

##### Glasser atlas
cd ${SUBJECTS_DIR}/${subj}/mri
glasser_data_dir=/data/pulkit/exvivo_reg_reconstruct/surface_stuff_freesurfer/miccai_stuff/freesurfer_exvivo_outputs/126704L_redo_correct_ribbon/glasser

mri_surf2surf --hemi ${hemis} \
  --srcsubject fsaverage \
  --trgsubject ${subj} \
  --sval-annot ${glasser_data_dir}/${hemis}.HCP-MMP1.annot \
  --tval ${SUBJECTS_DIR}/${subj}/label/${hemis}.aparc.HCP-MMP1.glasser.annot

SUBJECTS_DIR=${freesurfer_surface_processed}

######## dummy left needed for stats computation
...
#@# AParc-to-ASeg aparc
cd ${SUBJECTS_DIR}/${subj}/mri
mri_surf2volseg --o aparc+aseg.mgz --label-cortex --i aseg.mgz --threads 64 \
...
--label-cortex --i aseg.mgz --threads 64 \
...
--label-wm --i aparc+aseg.mgz --threads 64 \
...
--subject ${subj} \
--surf-wm-vol --ctab /data/pulkit/exvivo_reg_reconstruct/freesurfer_installation/freesurfer/WMParcStatsLUT.txt --etiv
...
--ctab /data/pulkit/exvivo_reg_reconstruct/freesurfer_installation/freesurfer/ASegStatsLUT.txt \
--subject ${subj}
